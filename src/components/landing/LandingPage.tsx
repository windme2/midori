...
const CALCULATOR_TYPES = [
  { key: "PET", label: "Plastic Bottle", rate: 30, co2: 0.72, cashRate: 0.5 },
  { key: "CANS", label: "Aluminium Can", rate: 50, co2: 1.2, cashRate: 1.0 },
  { key: "GLASS", label: "Glass Bottle", rate: 14, co2: 0.4, cashRate: 0.2 },
  { key: "PAPER", label: "Cardboard", rate: 15, co2: 0.55, cashRate: 0.25 },
  { key: "E_WASTE", label: "E-Waste", rate: 120, co2: 2.5, cashRate: 2.5 },
];
...
export function LandingPage({ onLaunch }: LandingPageProps) {
  ...
  useEffect(() => {
    const origin =
      typeof window !== "undefined"
        ...
        : "https://midori-waste-bank.vercel.app";
    ...
    if (androidApkUrl) {
      QRCode.toDataURL(androidApkUrl, { margin: 1, scale: 6 })
        ...
        .catch((err) =>
          console.error("Android APK QR code generation error:", err),
        );
    }
  }, []);
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "radial-gradient(rgba(43,46,44,0.03) 1.5px, transparent 1.5px)",
    ...
    >
      ...
      <main>
        ...
        <section className="mx-auto max-w-6xl px-6 py-16 md:py-24 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            ...
            <p className="mt-6 max-w-xl text-base md:text-lg leading-relaxed text-[#2B2E2C]/65">
              Deposit recyclables at any Midori point, earn digital points in
              real-time, and redeem them for eco-friendly rewards. Minimalist
              Japandi aesthetics for a clean earth.
            </p>
            ...
            <div className="mt-8 flex flex-row flex-nowrap items-stretch gap-3 w-full sm:w-auto">
              ...
              <div className="relative group/qr flex flex-1 min-w-0 items-center justify-center gap-2 bg-white border border-[#EAEAE6] rounded-xl p-2 px-2.5 shadow-xs hover:border-[#5F7A61]/30 transition-all cursor-pointer select-none sm:flex-initial sm:px-3">
                <div className="h-10 w-10 bg-white border border-gray-100 rounded-lg p-0.5 flex items-center justify-center shrink-0">
                  <svg
                    className="w-full h-full text-[#2B2E2C]"
                    viewBox="0 0 100 100"
                    fill="none"
                ...
                <div className="text-left min-w-0">
                  <span className="text-[9px] font-extrabold text-[#5F7A61] uppercase tracking-wider block leading-none truncate">
                    Mobile App
                  </span>
                  <span className="text-[10px] font-bold text-[#2B2E2C] mt-1 block truncate">
                    Scan to install
                  </span>
                </div>
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 bg-white border border-[#EAEAE6] rounded-2xl p-4 shadow-xl opacity-0 scale-95 pointer-events-none group-hover/qr:opacity-100 group-hover/qr:scale-100 transition-all duration-300 z-50 w-80 flex flex-col items-center gap-3">
                  <span className="text-[11px] font-extrabold text-[#2B2E2C] uppercase tracking-wider block border-b border-gray-100 pb-1.5 w-full text-center">
                    iOS &amp; Android
                  </span>
                    ...
                    <div className="flex flex-col items-center gap-2">
                      <div className="w-24 h-24 bg-white border border-gray-100 rounded-xl p-1.5 flex items-center justify-center shadow-inner min-h-[96px] min-w-[96px]">
                        {qrIosUrl ? (
                          ...
                          <span className="text-[8px] text-gray-400 font-extrabold uppercase tracking-wider animate-pulse">
                            Generating...
                          </span>
                        )}
                      </div>
                      <span className="text-[9px] font-bold text-[#2B2E2C] text-center leading-none">
                        iOS (Safari PWA)
                      </span>
                      <span className="text-[7px] text-[#2B2E2C]/50 text-center">
                        Add to Home Screen
                      </span>
                    </div>
            ...
            <div className="mt-12 flex flex-wrap gap-8 border-t border-[#EAEAE6] pt-8 w-full">
              {[
                {
                  value: `${recycledCount.toFixed(1)}t`,
                ...
                <div key={stat.label}>
                  ...
                  <p className="text-xs text-[#2B2E2C]/50 font-semibold uppercase tracking-wider mt-0.5">
                    {stat.label}
                  </p>
                </div>
              ))}
          ...
          <div className="lg:col-span-5 flex justify-center w-full relative group">
            ...
            <div className="relative w-full max-w-[320px] aspect-[9/18.5] rounded-[42px] border-[8px] border-[#2B2E2C] shadow-2xl bg-[#F4F6F3] overflow-hidden flex flex-col">
              ...
              <div className="px-4 pt-6 pb-3 border-b border-[#EAEAE6] bg-white flex justify-between items-center text-xs font-bold text-[#2B2E2C]">
                ...
                <span className="text-[9px] bg-[#5F7A61]/10 text-[#5F7A61] px-2 py-0.5 rounded-full">
                  Aiko
                </span>
              </div>
              ...
              <div className="flex-1 p-3 overflow-hidden flex flex-col gap-3">
                ...
                <div className="rounded-2xl bg-[#F5F6F4] border border-[#E8EDE5] p-3 text-left">
                  <p className="font-mono text-2xl font-bold text-[#2B2E2C]">
                    1,420
                  </p>
                  <p className="text-[9px] text-[#2B2E2C]/50 font-semibold mt-0.5">
                    Points balance
                  </p>

                  <div className="mt-3 grid grid-cols-2 gap-1.5">
                    <div className="bg-white rounded-lg p-2 border border-[#EAEAE6] text-center shadow-sm">
                      <p className="text-[10px] font-bold text-[#5F7A61]">
                        12.4 kg
                      </p>
                ...
                <div className="grid grid-cols-3 gap-1.5">
                  {["Scan Item", "Log Deposit", "Drop-off"].map((txt) => (
                    <div
                      key={txt}
                      className="bg-white border border-[#EAEAE6] rounded-xl py-3 text-center text-[8px] font-extrabold text-[#2B2E2C] shadow-sm"
                    >
                      {txt}
                    </div>
                  ))}
                ...
                <div className="flex-1 bg-white border border-[#EAEAE6] rounded-xl p-2.5 text-left flex flex-col gap-2.5 overflow-hidden">
                  <p className="text-[9px] font-bold text-[#2B2E2C]">
                    Recent activity
                  </p>
                  {[
                    {
                    ...
                    {
                      title: "Paper bundle",
                      desc: "Yesterday • 10:14 AM",
                      pts: "+45",
                    },
                    {
                      title: "Glass jars x6",
                      desc: "2 days ago • 10:14 AM",
                      pts: "+24",
                    },
                    {
                      title: "Aluminum cans",
                      desc: "3 days ago • 10:14 AM",
                      pts: "+60",
                    },
                    {
                      title: "Cardboard box",
                      desc: "4 days ago • 10:14 AM",
                      pts: "+60",
                    },
                    {
                      title: "E-waste mouse",
                      desc: "5 days ago • 10:14 AM",
                      pts: "+120",
                    },
                  ].map((item, idx) => (
                    <div
                      key={idx}
                      className="flex justify-between items-center text-[8px] border-b border-[#F0F0EE]/70 pb-1.5 last:border-b-0 last:pb-0"
                    >
                      <div className="min-w-0">
                        <p className="font-bold text-[#2B2E2C] truncate">
                          {item.title}
                        </p>
                        <p className="text-[7px] text-[#2B2E2C]/40 mt-0.5">
                          {item.desc}
                        </p>
                      </div>
                      <span className="font-mono font-bold text-[#5F7A61] shrink-0">
                        {item.pts}
                      </span>
                    </div>
                  ))}
        ...
        <section
          id="concept"
          className="border-t border-[#EAEAE6] bg-[#FBFBFA] py-24 text-left"
        >
          <div className="mx-auto max-w-6xl px-6 grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
            ...
            <div className="lg:col-span-2 flex flex-col items-start gap-4">
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center p-6 bg-gradient-to-br from-[#E5ECE3] via-[#E2EADF] to-[#BAC9B6]/40 pointer-events-none -z-10">
                  <svg
                    className="w-2/3 h-2/3 text-[#5F7A61]/70"
                    viewBox="0 0 100 100"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
              ...
              <div>
                <span className="text-xs font-bold uppercase tracking-widest text-[#5F7A61] bg-[#E5ECE3] px-3.5 py-1 rounded-full">
                  DESIGN &amp; IDENTITY
                </span>
                ...
                <p className="mt-3 text-sm text-[#2B2E2C]/50 leading-relaxed">
                  Midori (緑 - green) balances Japanese minimalist design with
                  Scandinavian functionality (Japandi aesthetic), creating a
                  clean digital space for sustainability.
                </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-3 grid grid-cols-1 sm:grid-cols-2 gap-6 items-stretch">
              ...
              <div className="bg-white border border-[#EAEAE6] rounded-3xl p-6 shadow-xs flex flex-col gap-4">
                ...
                <div>
                  <h3 className="text-sm font-bold text-[#2B2E2C]">
                    About &amp; Core Philosophy
                  </h3>
                  <p className="text-xs text-[#2B2E2C]/60 leading-relaxed mt-2">
                    Named after the Japanese word for green, Midori stands for
                    organic growth, circular economy, and community-driven
                    actions. The platform represents simplicity, transparent
                    measurements, and immediate positive feedback loops.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white border border-[#EAEAE6] rounded-3xl p-6 shadow-xs flex flex-col justify-between gap-4">
                <div className="flex flex-col gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#2B2E2C]/60 leading-relaxed mt-2">
                      Midori utilizes nature-inspired tones to create a calming,
                      professional, and reliable atmosphere:
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 mt-2">
                  <div className="flex items-center gap-1.5 bg-[#F4F6F3] p-1 pr-2 rounded-full border border-[#BAC9B6]/40">
                    ...
                    <span className="text-[9px] font-mono font-bold text-[#2B2E2C]">
                      #2B2E2C
                    </span>
                  </div>
                  <div className="flex items-center gap-1.5 bg-[#F4F6F3] p-1 pr-2 rounded-full border border-[#BAC9B6]/40">
              ...
              <div className="bg-white border border-[#EAEAE6] rounded-3xl p-6 shadow-xs flex flex-col justify-between gap-4">
                <div className="flex flex-col gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#2B2E2C]/60 leading-relaxed mt-2">
                      Clean font pairings ensure content layout hierarchy and
                      seamless scannability:
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-2 mt-2">
                  <div className="border-b border-gray-50 pb-1.5">
                    <span className="text-[8px] font-extrabold text-[#2B2E2C]/40 uppercase tracking-widest block">
                      Sans-Serif (Outfit / Inter)
                    </span>
                    <span className="text-xs font-bold text-[#2B2E2C]">
                  ...
                  <div>
                    ...
                    <span className="text-xs font-mono font-bold text-[#5F7A61]">
              ...
              <div className="bg-white border border-[#EAEAE6] rounded-3xl p-6 shadow-xs flex flex-col justify-between gap-4">
                <div className="flex flex-col gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#2B2E2C]/60 leading-relaxed mt-2">
                      Midori combines Zen minimalism with Scandinavian
                      functionality. This fusion values clean open spaces,
                      simple structures, warm tones, and natural craft
                      materials.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-2 mt-2">
                  ...
                  <div>
                    ...
                    <span className="text-xs font-bold text-[#5F7A61]">
        ...
        <section
          id="features"
          className="border-t border-[#EAEAE6] bg-white relative overflow-hidden"
        >
          <div className="mx-auto max-w-6xl px-6 py-24 grid grid-cols-1 md:grid-cols-12 gap-12 items-start text-left">
            ...
            <div className="md:col-span-5 flex flex-col items-start gap-4">
              ...
              <p className="text-sm text-[#2B2E2C]/50 leading-relaxed">
                Midori integrates seamlessly with your routine. Clean, aesthetic
                layouts guide every deposit, verification, and redemption step.
                The dashboard is designed to provide you with instant progress
                metrics and zero-waste indicators. Experience a smooth digital
                banking workflow tailored specifically for environmental
                sustainability and local community engagement.
              </p>
              <p className="text-sm text-[#2B2E2C]/50 leading-relaxed mt-2">
                Additionally, our offline-first capability ensures you can view
                your digital passes, logs, and account balances even without
                network connectivity. Start participating in eco-challenges,
                track your green tier upgrades, and contribute to local
                recycling programs securely.
              </p>
            </div>
            ...
            <div className="md:col-span-7 flex flex-col gap-6 w-full">
              {FEATURES.map((feature) => (
                ...
                >
                  ...
                  <div>
                    <h3 className="text-base font-bold text-[#2B2E2C]">
                      {feature.title}
                    </h3>
                    <p className="mt-1.5 text-xs leading-relaxed text-[#2B2E2C]/60">
                      {feature.desc}
                    </p>
                  </div>
                </div>
        ...
        <section
          id="calculator"
          className="bg-[#FBFBFA] border-t border-[#EAEAE6] py-24"
        >
          <div className="mx-auto max-w-4xl px-6">
            <div className="text-center max-w-lg mx-auto mb-16">
              <span className="text-xs font-bold uppercase tracking-widest text-[#D9A05B] bg-[#F9F1E6] px-3.5 py-1 rounded-full">
                ESTIMATION TOOL
              </span>
              <h2 className="mt-4 text-3xl font-extrabold tracking-tight text-[#2B2E2C] sm:text-4xl">
            ...
            <div className="rounded-3xl border border-[#EAEAE6] bg-white p-8 shadow-sm grid grid-cols-1 md:grid-cols-12 gap-10 items-stretch">
              ...
              <div className="md:col-span-7 flex flex-col justify-between gap-8 text-left">
                <div>
                  <h3 className="text-xs font-bold text-[#2B2E2C]/40 uppercase tracking-widest mb-3">
                    1. Select recyclable type
                  </h3>
                ...
                <div>
                  <div className="flex justify-between items-center mb-3">
                    <h3 className="text-xs font-bold text-[#2B2E2C]/40 uppercase tracking-widest">
                      2. Adjust batch weight
                    </h3>
              ...
              <div className="md:col-span-5 bg-[#F4F6F3] border border-[#E8EDE5] rounded-2xl p-6 flex flex-col justify-between text-left">
                <div className="flex flex-col gap-4">
                  <span className="text-[10px] font-bold text-[#2B2E2C]/40 uppercase tracking-widest block">
                    ESTIMATED YIELD
                  </span>

                  <div>
                    <span className="text-[9px] font-bold text-[#2B2E2C]/50 block">
                      POINTS EARNED
                    </span>
                    <span className="font-mono text-3xl font-extrabold text-[#5F7A61]">
                  ...
                  <div>
                    ...
                    <span className="font-mono text-2xl font-bold text-[#D9A05B]">
        ...
        <section id="how" className="border-t border-[#EAEAE6] bg-white py-24">
          <div className="mx-auto max-w-6xl px-6 text-center">
            ...
            <p className="mt-4 text-sm text-[#2B2E2C]/50 max-w-lg mx-auto">
              From sorting waste at home to redeeming rewards, we keep your
              recycling loops clear and effortless.
            </p>
            ...
            <div className="mt-16 relative">
              ...
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4 relative z-10">
                {HOW_IT_WORKS_STEPS.map((s) => (
                  <div
                    key={s.step}
                    className="rounded-3xl border border-[#EAEAE6] bg-[#FBFBFA] p-6 text-left hover:border-[#5F7A61]/30 transition-all duration-300 flex flex-col justify-between min-h-[220px]"
                  >
                    <div>
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="font-mono text-2xl font-bold text-[#EAEAE6]">
                          {s.step}
                        </span>
                      </div>
                      <h3 className="text-base font-bold text-[#2B2E2C]">
                      ...
                      <p className="text-[10px] font-semibold text-[#5F7A61] mt-0.5">
                        {s.titleTh}
                      </p>
                      <p className="mt-3 text-xs leading-relaxed text-[#2B2E2C]/65">
                        {s.desc}
                      </p>
                    </div>
                    <p className="mt-2 text-[10px] leading-relaxed text-[#2B2E2C]/40 border-t border-[#EAEAE6]/70 pt-2">
                      {s.descTh}
                    </p>
                  </div>
                ))}
        ...
        <section
          id="rates"
          className="border-t border-[#EAEAE6] bg-[#FBFBFA] py-24"
        >
          <div className="mx-auto max-w-4xl px-6">
            ...
            <div className="overflow-hidden rounded-3xl border border-[#EAEAE6] bg-white shadow-sm">
              <div
                className="grid border-b border-[#EAEAE6] bg-[#FBFBFA] px-6 py-4 text-left"
              ...
              {RECYCLING_RATES.map((row, i) => (
                <div
                  ...
                  style={{ gridTemplateColumns: "repeat(16, minmax(0, 1fr))" }}
                >
                  <span className="col-span-8 text-xs font-bold text-[#2B2E2C]">
                    {row.type}
                  </span>
                  <span className="col-span-4 font-mono text-sm font-bold text-[#5F7A61]">
                    {row.ptsPerKg} pts
                  </span>
                  <span className="col-span-4 font-mono text-sm font-semibold text-[#D9A05B]">
                    {row.cashPerKg}
                  </span>
                </div>
              ))}
            ...
            <div className="mt-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 text-[10px] text-[#2B2E2C]/40 font-semibold text-left">
              <p>
                * Rates fluctuate according to global sustainability indexes and
                local market conditions.
              </p>
              <span className="flex items-center gap-1.5 text-[#5F7A61] shrink-0 font-bold uppercase tracking-wider">
                <ShieldCheck className="h-4 w-4" /> GUARANTEED EXCHANGE VALUE
              </span>
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-3xl px-6">
            <div className="text-center max-w-lg mx-auto mb-16">
              ...
              <p className="mt-4 text-sm text-[#2B2E2C]/50">
                Got questions about points, deposits, or rewards? Find quick
                answers below.
              </p>
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <div>
                        <span>{faq.q}</span>
                        <span className="block text-[10px] text-[#5F7A61] font-semibold mt-0.5">
                          {faq.qTh}
                        </span>
                      </div>
        ...
        <section className="border-t border-[#EAEAE6] relative overflow-hidden bg-[#2B2E2C] py-20 text-white">
          ...
          <div className="relative mx-auto flex max-w-4xl flex-col items-center gap-6 px-6 text-center">
            ...
            <p className="max-w-md text-sm leading-relaxed text-white/60">
              Join thousands of community members logging deposits, reducing
              carbon footprint, and reclaiming eco rewards.
            </p>
            <button
              onClick={onLaunch}
        ...
        <div className="mx-auto max-w-6xl px-6 grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-5 flex flex-col items-start gap-4">
            ...
            <p className="text-xs leading-relaxed text-white/60 max-w-sm text-left">
              Empowering communities to recycle with ease, transforming
              household waste into sustainable value for a cleaner tomorrow.
            </p>
            {/* Social Links */}
